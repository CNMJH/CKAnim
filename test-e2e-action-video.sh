...
# 清理：删除角色（级联删除分类）
echo "🧹 清理测试数据..."
curl -s -X DELETE "http://localhost:3002/api/admin/characters/$CHARACTER_ID" > /dev/null
curl -s -X DELETE "http://localhost:3002/api/admin/games/$GAME_ID" > /dev/null
echo "   ✅ 已删除游戏和角色"
echo ""
