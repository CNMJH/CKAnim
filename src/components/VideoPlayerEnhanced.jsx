    ...
    <div className="video-player-enhanced">
      ...
      {isDrawingBoardOpen && (
        <div className="controls-bar-drawing">
          ...
          >
            <svg viewBox="0 0 24 24" width="20" height="20">
              <path fill="white" d="M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1zm3-19C8.14 2 5 5.14 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26c1.81-1.27 3-3.36 3-5.74 0-3.86-3.14-7-7-7zm2.85 8.99c-.36.84-.93 1.5-1.85 1.91V15h-2v-2.1c-.92-.41-1.49-1.07-1.85-1.91-.23-.54-.15-1.17.25-1.59l1.59-1.59c.41-.41 1.04-.49 1.59-.25.54.23.9.76.9 1.35v1.19c0 .55.45 1 1 1s1-.45 1-1V8.91c0-.59.36-1.12.9-1.35.55-.24 1.18-.16 1.59.25l1.59 1.59c.4.42.48 1.05.25 1.59z"/>
            </svg>
          </button>
